...
# Modification: open() calls use __file__-relative paths instead of CWD-relative paths.
...
# Load facts
with open(_DATA_DIR / "age_facts.json") as f:
...
with open(_DATA_DIR / "static_facts.json") as f:
