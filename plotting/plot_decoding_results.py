...
GROUPS = [
    ...
    },
    {
        ...
        "model": "DeepSeek V3",
        "n": 1460,
        "supervised": 35.3, "supervised_min": 29.3, "supervised_max": 45.1,
    ...
    },
    {
        ...
        "model": "Kimi K2",
        "n": 2053,
        "supervised": 73.7, "supervised_min": 64.8, "supervised_max": 78.7,
        "haiku":      76.9, "haiku_min":      71.0, "haiku_max":      81.7,
        "sonnet":     90.5, "sonnet_min":     84.0, "sonnet_max":     94.3,
        "supervised_note": None,
    },
    {
        ...
        "model": "DeepSeek V3",
        "n": 2702,
        "supervised": 67.1, "supervised_min": 53.2, "supervised_max": 81.4,
    ...
    },
    {
        ...
        "model": "Kimi K2",
        "n": 2991,
        "supervised": 66.1, "supervised_min": 57.9, "supervised_max": 76.1,
        "haiku":      86.5, "haiku_min":      77.7, "haiku_max":      92.9,
        "sonnet":     91.4, "sonnet_min":     81.5, "sonnet_max":     99.2,
